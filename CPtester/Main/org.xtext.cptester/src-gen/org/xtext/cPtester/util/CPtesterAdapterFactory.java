...
public class CPtesterAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected CPtesterSwitch<Adapter> modelSwitch =
    new CPtesterSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseAndWhen(AndWhen object)
      {
        return createAndWhenAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.cPtester.AndWhen <em>And When</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createAndWhenAdapter()
  {
    return null;
  }
