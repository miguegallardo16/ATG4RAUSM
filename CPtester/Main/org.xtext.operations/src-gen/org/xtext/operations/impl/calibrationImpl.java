 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.operations.impl.calibrationImpl#getColor <em>Color</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationImpl#getH_min <em>Hmin</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationImpl#getS_min <em>Smin</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationImpl#getV_min <em>Vmin</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationImpl#getH_max <em>Hmax</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationImpl#getS_max <em>Smax</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationImpl#getV_max <em>Vmax</em>}</li>
 * </ul>
 *
 * @generated
 */
public class calibrationImpl extends CommandImpl implements calibration
{
  /**
  ...
  {
    return OperationsPackage.Literals.CALIBRATION;
  }
  ...
  public EList<Color> getColor()
  {
    if (color == null)
    {
      color = new EObjectContainmentEList<Color>(Color.class, this, OperationsPackage.CALIBRATION__COLOR);
    }
    return color;
  }
  ...
  public EList<H_min> getH_min()
  {
    if (h_min == null)
    {
      h_min = new EObjectContainmentEList<H_min>(H_min.class, this, OperationsPackage.CALIBRATION__HMIN);
    }
    return h_min;
  }
  ...
  public EList<S_min> getS_min()
  {
    if (s_min == null)
    {
      s_min = new EObjectContainmentEList<S_min>(S_min.class, this, OperationsPackage.CALIBRATION__SMIN);
    }
    return s_min;
  }
  ...
  public EList<V_min> getV_min()
  {
    if (v_min == null)
    {
      v_min = new EObjectContainmentEList<V_min>(V_min.class, this, OperationsPackage.CALIBRATION__VMIN);
    }
    return v_min;
  }
  ...
  public EList<H_max> getH_max()
  {
    if (h_max == null)
    {
      h_max = new EObjectContainmentEList<H_max>(H_max.class, this, OperationsPackage.CALIBRATION__HMAX);
    }
    return h_max;
  }
  ...
  public EList<S_max> getS_max()
  {
    if (s_max == null)
    {
      s_max = new EObjectContainmentEList<S_max>(S_max.class, this, OperationsPackage.CALIBRATION__SMAX);
    }
    return s_max;
  }
  ...
  public EList<V_max> getV_max()
  {
    if (v_max == null)
    {
      v_max = new EObjectContainmentEList<V_max>(V_max.class, this, OperationsPackage.CALIBRATION__VMAX);
    }
    return v_max;
  }
